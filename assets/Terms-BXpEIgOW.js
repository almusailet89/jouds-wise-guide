import{r as a,j as e}from"./vendor-motion-DMlLQ8XX.js";import{s as h,L as l}from"./index--GqR81uG.js";import{B as i,C as f,b as y,c as g,a as v}from"./card-D4JraxM3.js";import{S as b}from"./separator-tNcngo4D.js";import{A as w}from"./arrow-left-CMvyXNaX.js";import"./vendor-radix-BVIvAzO8.js";import"./vendor-supabase-Dbly6DSp.js";import"./vendor-charts-9CPCblrA.js";const L=()=>{const[u,o]=a.useState(""),[d,n]=a.useState(""),[m,r]=a.useState("");a.useEffect(()=>{p()},[]);const p=async()=>{try{const{data:t,error:c}=await h.from("agreement_versions").select("*").eq("type","terms").order("effective_date",{ascending:!1}).limit(1).single();if(c)throw c;o(t.content),n(t.version),r(new Date(t.effective_date).toLocaleDateString())}catch(t){console.error("Error fetching terms:",t),o(s()),n("1.0"),r(new Date().toLocaleDateString())}},s=()=>`
# Terms of Service
