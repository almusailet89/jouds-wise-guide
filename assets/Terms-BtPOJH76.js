import{r as a,j as e}from"./vendor-radix-CquO0ixQ.js";import{s as h,L as l}from"./index-Dk3FkyUU.js";import{B as i}from"./button-DsLEswqS.js";import{C as f,b as y,c as g,a as v}from"./card-BT0-11HU.js";import{S as b}from"./separator-D9Ua6_Zz.js";import{A as w}from"./arrow-left-B1sjMieq.js";import"./vendor-supabase-EwmwT0N2.js";import"./vendor-charts-DvU7TaWj.js";const L=()=>{const[u,o]=a.useState(""),[d,n]=a.useState(""),[m,r]=a.useState("");a.useEffect(()=>{p()},[]);const p=async()=>{try{const{data:t,error:c}=await h.from("agreement_versions").select("*").eq("type","terms").order("effective_date",{ascending:!1}).limit(1).single();if(c)throw c;o(t.content),n(t.version),r(new Date(t.effective_date).toLocaleDateString())}catch(t){console.error("Error fetching terms:",t),o(s()),n("1.0"),r(new Date().toLocaleDateString())}},s=()=>`
# Terms of Service
