import{r as a,j as e}from"./vendor-radix-CquO0ixQ.js";import{s as f,L as d}from"./index-C-c-IX_B.js";import{B as o}from"./button-B7WsZdQS.js";import{C as h,b as g,c as y,a as v}from"./card-B5TOMrf7.js";import{S as w}from"./separator-DttDBmNc.js";import{A as P}from"./arrow-left-CZTAeeRi.js";import"./vendor-supabase-EwmwT0N2.js";import"./vendor-charts-DvU7TaWj.js";const j=()=>{const[l,i]=a.useState(""),[u,n]=a.useState(""),[p,r]=a.useState("");a.useEffect(()=>{m()},[]);const m=async()=>{try{const{data:t,error:c}=await f.from("agreement_versions").select("*").eq("type","privacy").order("effective_date",{ascending:!1}).limit(1).single();if(c)throw c;i(t.content),n(t.version),r(new Date(t.effective_date).toLocaleDateString())}catch(t){console.error("Error fetching privacy policy:",t),i(s()),n("1.0"),r(new Date().toLocaleDateString())}},s=()=>`
# Privacy Policy
