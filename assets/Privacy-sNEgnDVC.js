import{r as a,j as e}from"./vendor-radix-CquO0ixQ.js";import{s as f,L as d}from"./index-CMhdhTbE.js";import{B as o}from"./button-CU4L7Vmb.js";import{C as h,b as g,c as y,a as v}from"./card-cf9lPHkg.js";import{S as w}from"./separator-CLig49t3.js";import{A as P}from"./arrow-left-8S-jkJ3a.js";import"./vendor-supabase-BpYHF7-C.js";import"./vendor-charts-DvU7TaWj.js";const j=()=>{const[l,i]=a.useState(""),[u,n]=a.useState(""),[p,r]=a.useState("");a.useEffect(()=>{m()},[]);const m=async()=>{try{const{data:t,error:c}=await f.from("agreement_versions").select("*").eq("type","privacy").order("effective_date",{ascending:!1}).limit(1).single();if(c)throw c;i(t.content),n(t.version),r(new Date(t.effective_date).toLocaleDateString())}catch(t){console.error("Error fetching privacy policy:",t),i(s()),n("1.0"),r(new Date().toLocaleDateString())}},s=()=>`
# Privacy Policy
