import{r as a,j as e}from"./vendor-motion-DMlLQ8XX.js";import{s as f,L as d}from"./index-Dg2Z9cm1.js";import{B as o,C as h,b as g,c as y,a as v}from"./card-C8NCkcMl.js";import{S as w}from"./separator-BfysR9qG.js";import{A as P}from"./arrow-left-W31Y_sRy.js";import"./vendor-radix-BVIvAzO8.js";import"./vendor-supabase-CNCdHXQ7.js";import"./vendor-charts-9CPCblrA.js";const j=()=>{const[l,i]=a.useState(""),[u,n]=a.useState(""),[p,r]=a.useState("");a.useEffect(()=>{m()},[]);const m=async()=>{try{const{data:t,error:c}=await f.from("agreement_versions").select("*").eq("type","privacy").order("effective_date",{ascending:!1}).limit(1).single();if(c)throw c;i(t.content),n(t.version),r(new Date(t.effective_date).toLocaleDateString())}catch(t){console.error("Error fetching privacy policy:",t),i(s()),n("1.0"),r(new Date().toLocaleDateString())}},s=()=>`
# Privacy Policy
